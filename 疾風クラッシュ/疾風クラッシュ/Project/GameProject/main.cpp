...
void Init()
{
	...
	CInput::SetButton(0, CInput::eButton14, 'W');
	CInput::SetButton(0, CInput::eButton15, 'D');
	CInput::SetButton(0, CInput::eButton16, 'A');
	CInput::SetButton(0, CInput::eButton17, 'Q');
	...
	// プレイヤーを生成
	new Player(
		CVector3D(SCREEN_WIDTH * 0.15f, 0.0f, 150.0f));
