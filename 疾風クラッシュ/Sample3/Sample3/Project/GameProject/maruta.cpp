...
#define CHIP_SIZE 600		// 1コマのサイズ
#define CENTER_POS CVector2D(128.0f, 184.0f)	// 中心座標
#define ENEMY_SPEED 5.0 //敵の速度


// スライムのアニメーションデータ
TexAnimData Maruta::ANIM_DATA[(int)EAnimType::Num] =
{
	{
		new TexAnim[4]
		{
...
// コンストラクタ
Maruta::Maruta(MarutaType type, const CVector3D& pos)
	: EnemyBase(pos)
	, mp_image(nullptr)
	, m_type(type)
{
	...
	if (m_type == MarutaType::maruta) imagePath = "maruta.png";
...
// 現在の状態を切り替え
void Maruta::ChangeState(EState state)
{
